  ...
  render() {
    return (
      ...
      <div class="board-border-littleL"></div>
        ...
        <div class="p-group-bus board-border-signsL"></div>
        ...
        <div class="p-group-airport board-border-signsL"></div>
